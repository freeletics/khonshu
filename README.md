...
```groovy
implementation 'com.freeletics.mad:navigator:0.8.1'
// when using composables for navigation
implementation 'com.freeletics.mad:navigator-compose:0.8.1'
// when using fragments for navigation (even if these contain composables)
implementation 'com.freeletics.mad:navigator-fragment:0.8.1'
```
...
```groovy
anvil  'com.freeletics.mad:whetstone-compiler:0.8.1'

implementation 'com.freeletics.mad:whetstone-runtime:0.8.1'
// when using Compose UI
implementation 'com.freeletics.mad:whetstone-runtime-compose:0.8.1'
// when using fragments (even if these contain Compose UI)
implementation 'com.freeletics.mad:whetstone-runtime-fragment:0.8.1'

// for the integration with Navigator
implementation 'com.freeletics.mad:whetstone-navigation:0.8.1'
// for the integration with Navigator - when using Compose UI
implementation 'com.freeletics.mad:whetstone-navigation-compose:0.8.1'
// for the integration with Navigator - when using fragments (even if these contain Compose UI)
implementation 'com.freeletics.mad:whetstone-navigation-fragment:0.8.1'
```
...
```groovy
implementation 'com.freeletics.mad:state-machine:0.8.1'
```
...
```groovy
implementation 'com.freeletics.mad:text-resource:0.8.1'
```
