...
import com.freeletics.mad.navigation.compose.test.OtherRoot
import com.freeletics.mad.navigation.compose.test.OtherRoute
import com.freeletics.mad.navigation.compose.test.SimpleActivity
import com.freeletics.mad.navigation.compose.test.SimpleRoot
import com.freeletics.mad.navigation.compose.test.SimpleRoute
import com.freeletics.mad.navigation.compose.test.ThirdRoute
import com.freeletics.mad.navigation.compose.test.destinations
import com.freeletics.mad.navigation.compose.test.otherRootDestination
import com.freeletics.mad.navigation.compose.test.otherRouteDestination
import com.freeletics.mad.navigation.compose.test.simpleRootDestination
import com.freeletics.mad.navigation.compose.test.simpleRouteDestination
import com.freeletics.mad.navigation.compose.test.thirdRouteDestination
...
internal class MultiStackNavigationExecutorTest {
    ...
    fun `popUpTo with route not present on the executor throws exception`() {
        ...
        assertThat(exception).hasMessageThat()
            .isEqualTo(
                "Route class com.freeletics.mad.navigation.compose.test.OtherRoute (Kotlin " +
