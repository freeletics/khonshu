...
internal class FileGeneratorTestCompose {
    ...
    fun `generates code for ComposeScreenData`() {
        ...
        val expected = """
            ...
            import com.freeletics.mad.codegen.compose.`internal`.rememberComponent
            ...
            @Composable
            @OptIn(InternalCodegenApi::class)
            public fun MadTest(arguments: Bundle) {
    ...
    fun `generates code for ComposeScreenData with navigation`() {
        ...
        val expected = """
            ...
            import com.freeletics.mad.navigation.compose.NavigationSetup
            ...
            @Composable
            @OptIn(InternalCodegenApi::class)
            public fun MadTest(testRoute: TestRoute) {
    ...
    fun `generates code for ComposeScreenData with Composable Dependencies`() {
        ...
        val expected = """
            ...
            @Composable
            @OptIn(InternalCodegenApi::class)
            public fun MadTest2(arguments: Bundle) {
              val component = rememberComponent(TestParentScope::class, arguments) { parentComponent:
