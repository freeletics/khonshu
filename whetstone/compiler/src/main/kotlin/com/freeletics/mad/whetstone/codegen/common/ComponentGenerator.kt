...
import com.freeletics.mad.whetstone.codegen.util.navigatorCloseableComponent
...
import com.freeletics.mad.whetstone.codegen.util.whetstoneCloseableComponent
...
internal class ComponentGenerator(
    ...
    private fun superinterface(): TypeName {
        return if (data.navigation != null) {
            navigatorCloseableComponent
        } else {
            whetstoneCloseableComponent
        }
    }
