...
public inline fun <reified T : NavRoot> RootScreenDestination(
    noinline screenContent: @Composable (T) -> Unit,
): NavDestination = RootScreen(T::class, screenContent)
